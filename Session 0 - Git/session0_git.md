...
<img src="img/GitBasics/Distr_version_control.png" alt="alt text" width="600">
...
![](img/Branching_and_Merging/Branching_step1.svg)
...
![](img/Branching_and_Merging/Branching_step2.svg)
...
![](img/Branching_and_Merging/Branching_step3.svg)
...
![](img/Branching_and_Merging/Branching_step4.svg)
...
![](img/Branching_and_Merging/Merging_fastforward.svg)
...
![](img/Branching_and_Merging/Merging_3way.svg)
...
![](img/Branching_and_Merging/Merging_conflict.svg)
...
![](img/Workflow/Simple_workflow.svg)


## Advanced workflow example (often referred to as Git Flow)
![](img/Workflow/GitFlow.png)
...
From VS Code this command can be done like this:

![](img/VScode/git_init_from_vscode.png)

---
<!-- _class: center-content -->
## VS Code - Source control tab
![](img/VSCode/source_control_tab.png)
...
![](img/Non_text_files/wall_how_to_merge.jpg)
...
![](img/Exercises/VScode_changes.png)
...
![](img/Exercises/exercise_10_ff_merge.svg)
...
![](img/Exercises/exercise_10_no_ff_merge.svg)